...
igxy_sig = gxy.createIntegral(
    x_and_y, ROOT.RooFit.NormSet(x_and_y), ROOT.RooFit.Range("signal")
)
...
hh_cdf = gxy_cdf.createHistogram(
    "hh_cdf", x, ROOT.RooFit.Binning(40), ROOT.RooFit.YVar(y, ROOT.RooFit.Binning(40))
)
