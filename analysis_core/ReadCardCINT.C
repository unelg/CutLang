#ifndef __READCARDCINT_CPP
#define __READCARDCINT_CPP
...
double ReadCard(const char *filename, const char *varname,
		const double defval=0.000001, const int verbose=0 ) {
