...
c.NotebookApp.root_dir = os.environ["CUTLANG_PATH"] + "/binder"
c.NotebookApp.notebook_dir = os.environ["CUTLANG_PATH"] + "/binder"
c.ServerApp.root_dir = os.environ["CUTLANG_PATH"] + "/binder"
c.ServerApp.notebook_dir = os.environ["CUTLANG_PATH"] + "/binder"
...
#  Default: 'isaacturing112358'
# c.Session.username = 'isaacturing112358'
...
#  Choices: any of ['md5', 'sha224', 'sha1', 'blake2b', 'sha512', 'blake2s', 'sha384', 'sha256', 'sha3_384', 'sha3_224', 'sha3_256', 'sha3_512']
#  Default: 'sha256'
