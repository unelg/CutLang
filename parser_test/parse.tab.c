...
{
  "$end", "error", "$undefined", "DEF", "VARDEF", "CMD", "NB", "ID",
  "SIN", "COS", "TAN", "'+'", "'-'", "'*'", "'/'", "Unary", "'^'",
  "$accept", "input", "definitions", "definition", 0
};
#endif
